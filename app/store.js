...
(function () {
  ...
  const Store = {
    ...
    async init() {
      ...
      const defaults = { theme: null, selectedYear: null, lastBackupAt: null, seedVersion: 0, weightUnit: "lb", sex: "male", accent: "violet", animations: true, goals: { calPerDay: null, durPerDay: null, workoutsPerWeek: null } };
